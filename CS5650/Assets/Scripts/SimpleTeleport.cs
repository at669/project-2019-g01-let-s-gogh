...
/// <summary>
/// When this component is enabled, the player will be able to aim and trigger teleport behavior without Avatar Touch controllers
/// </summary>
public class SimpleTeleport : TeleportInputHandlerHMD
{
	/// <summary>
	...
	public override void GetAimData(out Ray aimRay)
	{
		...
		Vector3 ltouchPosition = trackingSpace.TransformPoint(OVRInput.GetLocalControllerPosition(OVRInput.Controller.LTouch));
		Vector3 ltouchRotation = trackingSpace.TransformDirection(OVRInput.GetLocalControllerRotation(OVRInput.Controller.LTouch).eulerAngles);
		Vector3 rtouchPosition = trackingSpace.TransformPoint(OVRInput.GetLocalControllerPosition(OVRInput.Controller.RTouch));
		Vector3 rtouchRotation = trackingSpace.TransformDirection(OVRInput.GetLocalControllerRotation(OVRInput.Controller.RTouch).eulerAngles);
        Vector3 controllerPosition = (sourceController == OVRInput.Controller.LTouch) ? ltouchPosition: rtouchPosition;
        Quaternion controllerRotation = (sourceController == OVRInput.Controller.LTouch) ? Quaternion.Euler(ltouchRotation) : Quaternion.Euler(rtouchRotation);
		
		aimRay = new Ray(controllerPosition, controllerRotation*Vector3.forward);
